...
define config.name = _("QUINCENTRA_ENGLISH")
...
define build.name = "QUINCENTRA_ENGLISH"
...
define config.intra_transition = False
...
define config.save_directory = "QUINCENTRA"
